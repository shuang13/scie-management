...
require ('!style-loader!css-loader!sass-loader!C:/Users/1234/Desktop/v2.0/public-resource/css/components-dir/base.scss');
$(document).ready(function () {
    ...
    $('.btn-submit').on('click', function (event) {
        ...
        $.ajax({
            type: 'POST',
            url: 'http://127.0.0.1:80/SCIEManagement/category/add/doc',
            data: ajaxArgs,
            success: function(data){
                if(typeof data === 'string') {
                    data = JSON.parse(data);
